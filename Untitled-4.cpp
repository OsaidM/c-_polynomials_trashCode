...
// int findTermInPoly(int *arr[], int &termExponent, int size){
//     for(int i=0;i<size; i++){
//         cout << arr[i][1] << termExponent;
//         if(arr[i][1] == termExponent)
//             return i;
//     }
//     return -1;
// }
...
void addPoly(int *firstArrayOfTerms[], int *secondArrayOfTerms[], int firstSize, int secondSize)
{
    if(firstSize > secondSize){ // if firstSize is bigger
        ...
        for (i; i < firstSize; i++)
        {
            for(j; j < secondSize;){// i =0, 1, 2 ______ newSize= 2, 3
                ...
                if(firstArrayOfTerms[i][1] == secondArrayOfTerms[j][1]){
                    ...
                    cout << endl <<additionOfPoly[j][0] << "\t" << additionOfPoly[j][1] << endl;
                    cout << endl <<additionOfPoly[j+1][0] << "\t" << additionOfPoly[j+1][1] << endl;
                    newSize++;
                    j++;
                    break;
                }else{// j = 0, 1, 2
        ...
        if(i > secondSize){
            for(int z=i-1; z< firstSize; z++){
                if(firstArrayOfTerms[z]){
                    cout << "working " << firstArrayOfTerms[z-1][0] << firstArrayOfTerms[z-1][1];
                    additionOfPoly[newSize][0] = firstArrayOfTerms[z-1][0];
                    additionOfPoly[newSize][1] = firstArrayOfTerms[z-1][1];
                    
                    newSize++;
                }else{
                    additionOfPoly[newSize][0] = firstArrayOfTerms[z][0];
                    additionOfPoly[newSize][1] = firstArrayOfTerms[z][1];
                    newSize++;
                }
            }
        }
        ...
        // ==============
        cout << "working " << i << j << secondSize << newSize;
        if(i > secondSize){
            for(int z=i-2; z< secondSize; z++){
                if(firstArrayOfTerms[z]){
                    cout << "working " << secondArrayOfTerms[z-1][0] << secondArrayOfTerms[z-1][1];
                    additionOfPoly[newSize][0] = secondArrayOfTerms[z][0];
                    additionOfPoly[newSize][1] = secondArrayOfTerms[z][1];
                    cout << "working";
                    newSize++;
                }else{
                    additionOfPoly[newSize][0] = secondArrayOfTerms[z][0];
